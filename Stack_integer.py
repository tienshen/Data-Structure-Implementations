...
if __name__ == '__main__':
    ...
    print("pop top value: " + str(integer_stack.Pop()))
    print("peek top value: " + str(integer_stack.Peek()))
    print("size? " + str(integer_stack.GetSize()))
    print("is empty? " + str(integer_stack.IsEmpty()))

    for x in range(integer_stack.GetSize()):
        print("pop top value: " + str(integer_stack.Pop()))
