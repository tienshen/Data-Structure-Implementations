...
from Stack_integer import Stack
...
if __name__ == '__main__':
    ...
    # initial test if methods are working
    print("integer_queue is empty: " + str(integer_queue.IsEmpty()))
    print("size is: " + str(integer_queue.GetSize()))

    # enqueque some names
    print("size of queue after enqueueing:")
    print(integer_queue.Enqueue("Max"))
    print(integer_queue.Enqueue("Timmy"))
    print(integer_queue.Enqueue("Derrick"))
    print(integer_queue.Enqueue("Ryan"))

    # test if size still works
    print("integer queue is empty: " + str(integer_queue.IsEmpty()))
    print("size is: " + str(integer_queue.GetSize()))

    # test dequequeing
    print("names dequeued:")
    for x in range(integer_queue.GetSize()):
        print(integer_queue.Dequeue())
